...
This is a basic registry browser for Mythic v3.4.11+. 
This container connects up to RabbitMQ queues for custom browsers and processes data for the custom browser "registry_browser".
